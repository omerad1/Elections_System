...
#ifndef SOCIALDEMOCRAT_H
#define SOCIALDEMOCRAT_H
...
public:
    ...
    /**
     * Democratic - Social - politician constructor
     ...
     */
    explicit SocialDemocrat(string  first_name, string  last_name , int d_id , int power = 0,
                              Politician* cha_man = nullptr , Party* p = nullptr);

    /**
     * destructor
     */
    ~SocialDemocrat() override;

...
#ifndef SOCIALREPUBLICAN_H
#define SOCIALREPUBLICAN_H

#include "Politician.h"

class SocialRepublican: public Politician{

public:

    /**
     * Republican - Social - politician constructor
     ...
     */
    explicit SocialRepublican(string  first_name, string  last_name , int d_id , int power = 0,
                              Politician* cha_man = nullptr , Party* p = nullptr);

    /**
     * destructor
     */
    ~SocialRepublican() override;
